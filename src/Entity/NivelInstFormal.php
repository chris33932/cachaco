...
/**
 * @ORM\Entity(repositoryClass=NivelInstFormalRepository::class)
 */
class NivelInstFormal
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=Victima::class, mappedBy="niv_inst_form")
     */
    private $victimas;
    ...
    public function removeVictima(Victima $victima): self
    {
        if ($this->victimas->removeElement($victima)) {
            ...
            if ($victima->getNivInstForm() === $this) {
                $victima->setNivInstForm(null);
            }
        }
