...
/**
 * @ORM\Entity(repositoryClass=TipoFemicidioRepository::class)
 */
class TipoFemicidio
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Victima::class, mappedBy="tipo_femicidio")
     */
    private $victimas;
    ...
    public function removeVictima(Victima $victima): self
    {
        if ($this->victimas->removeElement($victima)) {
            ...
            if ($victima->getTipoFemicidio() === $this) {
                $victima->setTipoFemicidio(null);
            }
        }
